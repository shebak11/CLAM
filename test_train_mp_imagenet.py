...
def train_imagenet(index =0):
  ...
  local_file_path = "/home/MacOS/TCGA-3L-AA1B-01A-01-TS1.9C415218-D5B4-4945-B243-F42A4C8C0484-2.h5"
  local_file_path_ar = [ "/home/MacOS/TCGA-3L-AA1B-01A-01-TS1.9C415218-D5B4-4945-B243-F42A4C8C0484.h5",
  ...
  i=0
  #for i in range(3):
  #dataset = Whole_Slide_Bag_FP(file_path=local_file_path_ar[i], wsi=wsi, pretrained=pretrained,  custom_downsample=custom_downsample, target_patch_size=target_patch_size)
